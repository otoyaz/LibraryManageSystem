<template>
  <div id="HelloWorld">
    ...
    <article>
      <el-col :span="4">
        <el-menu router default-active="2" class="el-menu-vertical-demo" text-color="#303133" :collapse="isCollapse">
          ...
          <el-submenu index="/student">
            <template slot="title">
              ...
              <el-menu-item-group>
                ...
                <span>用户信息</span></el-menu-item>
                <el-menu-item index="/backhome/studentrecord">
                <i class="el-icon-star-on"></i>
                <span>用户借阅历史</span></el-menu-item>
              </el-menu-item-group>
          </el-submenu>
          <!-- 这里新加一个top排行管理 -->
